//! GitHub CLI Tool Configuration Example
//!
//! This example demonstrates how to load and validate the gh (GitHub CLI) tool configuration
...
fn main() {
    ...
    let config_path = manifest_dir.join("examples/configs/gh.json");

    println!(
        "Loading gh tool configuration from: {}",
        config_path.display()
    );
