...
async fn test_subcommand_configuration_handling() -> Result<()> {
    ...
    let subcommand_config = SubcommandConfig {
        ...
        positional_args: Some(vec![ahma_mcp::config::CommandOption {
...
async fn test_file_based_argument_handling() -> Result<()> {
    ...
    let subcommand_config = SubcommandConfig {
        ...
        options: Some(vec![ahma_mcp::config::CommandOption {
...
async fn test_async_operations_with_callbacks() -> Result<()> {
    ...
    impl ahma_mcp::callback_system::CallbackSender for MockCallback {
        async fn send_progress(
            &self,
            _update: ahma_mcp::callback_system::ProgressUpdate,
