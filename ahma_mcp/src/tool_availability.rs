...
/// Returns `"<empty>"` for empty strings, otherwise the string itself.
...
/// Build a human-readable message for a failed probe.
...
/// Log a probe failure and optional install hint.
