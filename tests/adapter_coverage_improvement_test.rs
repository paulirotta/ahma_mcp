    ...
    let complex_config = SubcommandConfig {
        ...
        positional_args: Some(vec![
            OptionConfig {
                ...
                description: "First positional".to_string(),
                format: None,
                required: Some(true),
                file_arg: Some(false),
                file_flag: None,
            ...
            OptionConfig {
                ...
                description: "Array positional".to_string(),
                format: None,
                required: Some(false),
                file_arg: Some(false),
                file_flag: None,
        ...
        options: Some(vec![
            OptionConfig {
                ...
                option_type: "string".to_string(),
                description: "File content option".to_string(),
                format: None,
                required: Some(false),
                file_arg: Some(true),
...
async fn test_file_handling_error_scenarios() -> Result<()> {
    ...
    let file_config = SubcommandConfig {
        ...
        options: Some(vec![OptionConfig {
            ...
            alias: None,
            option_type: "string".to_string(),
            description: "Content to handle".to_string(),
            format: None,
            required: Some(false),
            file_arg: Some(true),
...
async fn test_complex_async_exec_options() -> Result<()> {
    ...
    let subcommand_config = SubcommandConfig {
        ...
        positional_args: Some(vec![OptionConfig {
            ...
            alias: None,
            option_type: "string".to_string(),
            description: "Target argument".to_string(),
