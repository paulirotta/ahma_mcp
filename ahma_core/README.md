...
For full documentation and architecture details, see the [Ahma Core Documentation](https://paulirotta.github.io/ahma_mcp/doc/ahma_core/index.html) (generated via `cargo doc`).
