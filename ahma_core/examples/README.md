...
```
Loading cargo tool configuration from: /path/to/ahma_core/examples/configs/cargo.json
...
The examples use the `MtdfValidator` from `ahma_core::schema_validation` to validate configurations against the MTDF schema. This ensures:
...
- [ahma_core/src/schema_validation.rs](../src/schema_validation.rs) - Validation implementation
