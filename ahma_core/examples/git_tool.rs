//! Git Tool Configuration Example
//!
//! This example demonstrates how to load and validate the git tool configuration
...
fn main() {
    ...
    let config_path = manifest_dir.join("examples/configs/git.json");

    println!(
        "Loading git tool configuration from: {}",
        config_path.display()
    );
